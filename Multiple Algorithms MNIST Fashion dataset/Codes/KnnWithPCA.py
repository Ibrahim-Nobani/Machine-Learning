...
print(current_time)
# steps = [('scaling', StandardScaler()), ('reduce_dim', PCA(n_components=50,tol=0.1)), ('clf', KNeighborsClassifier(n_neighbors=5, metric='manhattan'))]
steps = [('scaling', StandardScaler()), ('reduce_dim', PCA(n_components=85,tol=0.1)), ('clf', KNeighborsClassifier(n_neighbors=5, metric='manhattan'))]
# steps = [('scaling', StandardScaler()), ('reduce_dim', PCA(n_components=100,tol=0.1)), ('clf', KNeighborsClassifier(n_neighbors=5, metric='manhattan'))]
