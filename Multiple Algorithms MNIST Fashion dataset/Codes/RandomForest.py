...
# train_random_forest(x_train_split, y_train_split, x_validation, y_validation, x_test, y_test, 100,'entropy')
# train_random_forest(x_train_split, y_train_split, x_validation, y_validation, x_test, y_test, 100,'gini')
# train_random_forest(x_train_split, y_train_split, x_validation, y_validation, x_test, y_test, 250,'entropy')
#train_random_forest(x_train_split, y_train_split, x_validation, y_validation, x_test, y_test, 250,'gini')
train_random_forest(x_train_split, y_train_split, x_validation, y_validation, x_test, y_test, 500,'entropy')
#train_random_forest(x_train_split, y_train_split, x_validation, y_validation, x_test, y_test, 500,'gini')