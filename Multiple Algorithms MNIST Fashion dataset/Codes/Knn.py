...
def KNN(neighbors, metric, xTrain, yTrain, xValid, yValid, xTest, yTest):
    # create a KNN classifier with 3 neighbors and manhattan distance metric
...
KNN(1, 'euclidean', x_train_split, y_train_split, x_validation, y_validation,x_test, y_test)
# KNN(3, 'euclidean', x_train_split, y_train_split, x_validation, y_validation,x_test, y_test)
# KNN(1, 'manhattan', x_train_split, y_train_split, x_validation, y_validation,x_test, y_test)
# KNN(3, 'manhattan', x_train_split, y_train_split, x_validation, y_validation,x_test, y_test)
# KNN(5, 'manhattan', x_train_split, y_train_split, x_validation, y_validation, x_test, y_test)